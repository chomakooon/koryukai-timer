...
export function Timer() {
  ...
  const renderColoredLabel = (step: TimerStep) => {
    ...
    if (step.type === 'talk') {
      return (
        <span className="inline-flex items-center gap-2">
          <span className="flex h-10 w-12 items-center justify-center rounded-none border-2 border-black text-white font-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] tracking-normal leading-none" style={{ backgroundColor: speakerColor }}>{step.speaker}</span>
    ...
    return (
      <span className="inline-flex items-center gap-2">
        <span className="flex h-10 w-10 items-center justify-center rounded-none border-2 border-black text-white font-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] tracking-normal leading-none" style={{ backgroundColor: speakerColor }}>{step.speaker}</span>
        <span className="font-black mx-1 inherit-text">×</span>
        <span className="flex h-10 w-10 items-center justify-center rounded-none border-2 border-black text-white font-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] tracking-normal leading-none" style={{ backgroundColor: questionerColor }}>{step.questioner}</span>
              ...
              <div className="text-[22px] font-black tracking-wider flex flex-col items-center justify-center gap-2 drop-shadow-[2px_2px_0px_rgba(255,255,255,0.7)]">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-xl">
                    （{Math.floor(nextStep.durationSec / 60)}分{nextStep.durationSec % 60 > 0 ? `${nextStep.durationSec % 60}秒` : ''}）
                  </span>
                </div>
              </div>
            )}
